...
<a href="http://localhost/Allensuport/users/complaintdocs/<?php echo $row['complaintFile']; ?>" target="_blank">View File</a>
<?php } ?></td>
</tr>
...
<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/Allensuport/admin/updatecomplaint.php?cid=<?php echo htmlentities($row['complaintNumber']);?>');" title="Update order">
											 <button type="button" class="btn btn-primary">Take Action</button></td>
											</a><?php } ?></td>
											<td colspan="4"> 
											<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/Allensuport/admin/userprofile.php?uid=<?php echo htmlentities($row['userId']);?>');" title="Update order">
